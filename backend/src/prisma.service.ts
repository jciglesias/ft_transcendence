...
import { setUser, getUserAccount, setFriend, set2FA, updateUserScore, updateUserStatus, getBlockedUsers, getFriends, getUser, uploadPhoto } from './prisma/user.service';
